          ...
          <div className={cn('main-container')}>
            ...
            <div className="main-bar">
              <Textarea
                ...
                placeholder={
                  voiceListening
                    ? 'The conversation is ongoing... Just say "Send" when the conversation is complete'
                    : 'Shift + Enter to change the line, enter/select the prompt word'
                }
                spellCheck={false}
            ...
            <div className="body-1 bottom-bar">
              ...
              <div className="flex gap-2 items-center">
                <div className="letter-counter">
                  <span>{input.length}</span>/8000
                </div>
                <button type="submit" className="action-button" onClick={onSend}>
                  <SVG
                    alt="send"
                    src={input.length ? SendFillIcon : SendIcon}
                    width={18}
                    height={20}
                  />
                </button>
